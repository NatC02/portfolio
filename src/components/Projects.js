...
import sephardicCenterShowCase from '../assets/images/sephardicCenterShowcase.gif'
import loginDemo from '../assets/images/loginProjectDemo.gif'
import studentDemo from '../assets/images/studentProjectDemo.gif'
              ...
              <article className="project">
                ...
                <div className="project-content">
                  ...
                  <p className="project-desc">
                    ...
                    a resource for the Sephardic Jewish Center of Forest Hills, New
                    Jersey.
                  </p>
